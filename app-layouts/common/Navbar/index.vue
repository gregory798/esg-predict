	...
	:deep() {
		...
		.n-menu-item-group {
			.item-badge {
				...
				:nth-child(2) {
					...
					background: rgba(var(--hover-color-rgb) / 0.5);
					height: 22px;
					line-height: 24px;
					border-radius: 15px;
					padding: 0 7px;
		...
		.n-submenu-children {
			...
			&::before {
				content: "";
				display: block;
				background-color: rgba(var(--divider-color-rgb) / 0.5);
				...
				.n-menu-item-content {
					&::after {
						...
						background: repeating-linear-gradient(
							90deg,
							rgba(var(--divider-color-rgb) / 0.5) 0px,
							rgba(var(--divider-color-rgb) / 0.5) 5px,
							transparent 5px,
							transparent 8px
						);
					}
